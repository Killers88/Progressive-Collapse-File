...
import edu.mit.civil.blastassessment.cli.retrievingBeamSections;
 ...
 * 
 */
public class BlastAssessmentAppWork {
	...
	public static String scenario() {
		...
		System.out.println(windForces.designWindPressure(floorHeight,
				numberOfStorys, tributaryWidth, windspeed));
		...
		System.out.println(beamDesign.sectionDesign(bayWidth, tributaryWidth,
				deadLoad, liveLoad, 50, beamaxial, beamFactorOfSafety,
		...
		System.out.println(EquivalentDurationTrAlpha
				.calculateEquivalentDurationWithIsAndPr(ImpulseIralpha
						.calculateImpulseIsUFCGraph(PeakIncidentOverPressurePso
								.findPeakIncidentOverPressureWith(z),
								blastAngle, weightTNT), ReflectedPressurePr
						.findReflectedPressureWith(blastAngle,
								PeakIncidentOverPressurePso
										.findPeakIncidentOverPressureWith(z))));
		...
		System.out.println(AppliedLoadingToColumnQ.calculateAppliedLoading(
				ReflectedPressurePr.findReflectedPressureWith(blastAngle,
						PeakIncidentOverPressurePso
								.findPeakIncidentOverPressureWith(z)),
				columnFlangeWidth, floorHeight));

		System.out.println(ActualStiffnessK.calculateColumnActualStiffness(
				youngsMod, columnIxx, floorHeight));

		System.out.println(TotalActalMassM.calculatingTotalActualMass(
				columnLinearWeight, floorHeight));
		...
		System.out.println(YieldDisplacementUy.calculateYieldDisplacementUy(
		...
		System.out.println(ActualStiffnessK.stiffnessFIX(youngsMod, columnIxx,
				floorHeight));
		...
		System.out.println(YieldDisplacementUy
				.calculateYieldDisplacementUyFIXED(floorHeight, columnSx,
						yieldStrength, youngsMod, columnIxx));

		System.out.println();

		System.out.println("COLUMN - ELASTIC ASSESSMENT");

		System.out.println(EquivalentSDOFPropertiesElastic
				.stiffnessOfEquivSDOF(ActualStiffnessK
						.calculateColumnActualStiffness(youngsMod, columnIxx,
								floorHeight)));

		System.out.println(EquivalentSDOFPropertiesElastic
				.massOfEquivSDOF(TotalActalMassM.calculatingTotalActualMass(
						columnLinearWeight, floorHeight)));

		System.out.println(EquivalentSDOFPropertiesElastic.naturalPeriodSDOF(
				EquivalentSDOFPropertiesElastic.massOfEquivSDOF(TotalActalMassM
						.calculatingTotalActualMass(columnLinearWeight,
								floorHeight)), EquivalentSDOFPropertiesElastic
						.stiffnessOfEquivSDOF(ActualStiffnessK
								.calculateColumnActualStiffness(youngsMod,
										columnIxx, floorHeight))));

		System.out
				.println(ParameterForElasticCheck.tEquivDividedByTn(
		...
		System.out
				.println(EquivalentSDOFElasticResponseUm.elasticResponseParameterCheck(
		...
		System.out
				.println(EquivalentSDOFElasticCheck.determiningDynamicLoadFactor(
		...
		System.out.println(EquivalentSDOFPropertiesPlastic
				.stiffnessOfEquivSDOF(ActualStiffnessK
						.calculateColumnActualStiffness(youngsMod, columnIxx,
								floorHeight)));
		...
		System.out.println(EquivalentSDOFPropertiesPlastic.naturalPeriodSDOF(
				EquivalentSDOFPropertiesPlastic.massOfEquivSDOF(TotalActalMassM
						.calculatingTotalActualMass(columnLinearWeight,
								floorHeight)), EquivalentSDOFPropertiesPlastic
						.stiffnessOfEquivSDOF(ActualStiffnessK
								.calculateColumnActualStiffness(youngsMod,
										columnIxx, floorHeight))));

		System.out.println(UltimateUnitResistance.calculatingPlasticMoment(
				yieldStrength, columnZx, floorHeight));

		System.out
				.println(EquivalentSDOFPlasticResponseUm.TeDivideTn(
						EquivalentDurationTrAlpha
								.calculateEquivalentDurationWithIsAndPr(
										ImpulseIralpha.calculateImpulseIsUFCGraph(
												PeakIncidentOverPressurePso
		...
		System.out.println(EquivalentSDOFPlasticResponseUm
				.maxDeflectionPlasticInputsRuDivideP(UltimateUnitResistance
						.calculatingPlasticMoment(yieldStrength, columnZx,
								floorHeight), ReflectedPressurePr
						.findReflectedPressureWith(blastAngle,
								PeakIncidentOverPressurePso
										.findPeakIncidentOverPressureWith(z)),
						columnFlangeWidth, floorHeight));
		...
		System.out
				.println(EquivalentSDOFPlasticResponseUm.peakResponseParameterPlastic(
						EquivalentDurationTrAlpha
								.calculateEquivalentDurationWithIsAndPr(
										ImpulseIralpha.calculateImpulseIsUFCGraph(
												PeakIncidentOverPressurePso
		...
		System.out
				.println(EquivalentSDOFPlasticResponseUm.maximumPlasticDeflection(
						EquivalentDurationTrAlpha
								.calculateEquivalentDurationWithIsAndPr(
										ImpulseIralpha.calculateImpulseIsUFCGraph(
												PeakIncidentOverPressurePso
		...
		System.out
				.println(EquivalentSDOFPlasticResponseUm.beamPlasticRotation(
						EquivalentDurationTrAlpha
								.calculateEquivalentDurationWithIsAndPr(
										ImpulseIralpha.calculateImpulseIsUFCGraph(
												PeakIncidentOverPressurePso
		...
		System.out
				.println(EquivalentSDOFPlasticResponseUm.plasticCheckFinal(
						EquivalentDurationTrAlpha
								.calculateEquivalentDurationWithIsAndPr(
										ImpulseIralpha.calculateImpulseIsUFCGraph(
												PeakIncidentOverPressurePso
		...
		System.out.println(beamDesignForces.maxBeamShear(bayWidth,
				tributaryWidth, deadLoad, liveLoad, dynamicAmpFactor,
				numberOfStorys, deadLoadFactorPC, liveLoadFactorPC)
				+ " Kips");

		System.out.println(beamDesignForces.maxBeamMoment(bayWidth,
				tributaryWidth, deadLoad, liveLoad, dynamicAmpFactor,
				numberOfStorys, deadLoadFactorPC, liveLoadFactorPC,
		...
		System.out.println(beamChecks.flexuralCheck(beamZx, bayWidth, beamLy,
				yieldStrength, beamRx, beamRy, youngsMod, beamArea));

		System.out.println(beamChecks.momentMmxFactor(beamZx, bayWidth, beamLy,
				yieldStrength, beamRx, beamRy, youngsMod, beamArea));

		System.out.println(beamChecks.momentMmxCheck(beamZx, bayWidth, beamLy,
				yieldStrength, beamRx, beamRy, youngsMod, beamArea));

		System.out.println(beamChecks.eulerBucklingStresses(youngsMod,
				bayWidth, beamRx));

		System.out.println(beamChecks.eulerBucklingLoads(youngsMod, bayWidth,
				beamRx, beamArea));

		System.out.println(beamChecks.ultCapacityForDynAxialLoadPp(
				yieldStrength, beamArea));

		System.out.println(beamChecks.combinedChcekOne(beamZx, bayWidth,
				beamLy, yieldStrength, beamRx, beamRy, youngsMod, beamArea,
				beamaxial, beamDesignForces.maxBeamMoment(bayWidth,
						tributaryWidth, deadLoad, liveLoad, dynamicAmpFactor,
						numberOfStorys, deadLoadFactorPC, liveLoadFactorPC,
						noOfFloorsBeamSupports)));

		System.out.println(beamChecks.combinedChcekTwo(beamZx, bayWidth,
				beamLy, yieldStrength, beamRx, beamRy, youngsMod, beamArea,
				beamaxial, beamDesignForces.maxBeamMoment(bayWidth,
						tributaryWidth, deadLoad, liveLoad, dynamicAmpFactor,
						numberOfStorys, deadLoadFactorPC, liveLoadFactorPC,
